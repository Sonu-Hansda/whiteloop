...
function Pricing() {
  ...
  return (
    <div className="p-8 rounded-2xl text-center mb-12" data-aos="fade-up">
      <button
        className="flex mx-auto mb-6 items-center justify-center bg-white rounded-2xl px-4 py-2 border border-gray-300 gap-x-1.5"
        data-aos="fade-up"
        data-aos-delay="100"
      >
        <RiUploadCloud2Fill />
      ...
      <div
        className="bg-white mx-auto mb-12 w-xs p-2 rounded-xl shadow-xl shadow-blue-950/40 flex"
        data-aos="fade-up"
        data-aos-delay="300"
      >
        <div
          className={`p-2 ${isMonth ? "bg-[#d8dfe5]" : ""} rounded-lg w-1/2 cursor-pointer`}
        ...
        <div
          ...
          onClick={() => setIsMonth((prev) => !prev)}
        >
          Yearly <span className="bg-white rounded-xl px-2.5 py-0.5">Save 30%</span>
        </div>
      </div>
      ...
      <div className="grid md:grid-cols-3 gap-8 text-start mb-8">
        {/* Card 1 */}
        <div
          className="w-full bg-[#f6fbff] p-4 rounded-xl shadow-lg"
          data-aos="fade-up"
          data-aos-delay="400"
        >
          <h5 className="mb-2 text-xl font-semibold">Starter</h5>
          <h4 className="mb-8 text-4xl font-semibold">
            $9 <span className="text-sm font-normal">user/month</span>
          </h4>
        ...
        <div
          ...
          data-aos-delay="500"
        >
          <h5 className="flex items-center mb-2 text-xl font-semibold">
            Pro{" "}
            <span className="ml-4 flex items-center bg-violet-600 rounded-full text-white text-sm px-2.5 py-1 space-x-1">
              <PiFire className="text-lg" /> <h4>Popular</h4>
            </span>
          </h5>
          <h4 className="mb-8 text-4xl font-semibold">
            $12 <span className="text-sm font-normal">user/month</span>
          </h4>
        ...
        >
          ...
          <h4 className="mb-8 text-4xl font-semibold">
            $80 <span className="text-sm font-normal">user/month</span>
          </h4>
          <button className="flex items-center space-x-4 justify-center bg-gradient-to-br from-[#c3cfdb] to-white w-full p-2 rounded-lg shadow-xl mb-8">
            <FaCrown />
            <h4>Get Started</h4>
      ...
      {/* Footer Message */}
      <p
        className="md:w-xl mx-auto mb-3 bg-[#d8dfe5] text-center p-2.5 rounded-lg"
        data-aos="fade-up"
        data-aos-delay="700"
      >
